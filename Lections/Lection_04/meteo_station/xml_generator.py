...
def create(device = 1):
    ...
    with open('GB_Python\Lections\Lection_04\meteo_station\log.xml', 'w') as page:
        page.write(xml)
...
def create_another(data, device = 1):
    ...
    with open('GB_Python\Lections\Lection_04\meteo_station\log_another.xml', 'w') as page:
        page.write(xml)
